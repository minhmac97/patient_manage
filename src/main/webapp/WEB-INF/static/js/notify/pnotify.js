...
(function (b, k) {
    ...
    var q = function (l) {
        ...
        b.extend(d.prototype, {
            ...
            parseOptions: function (c, a) {
                ...
                for (var p = [c, a], m, f = 0; f < p.length; f++) {
                    ...
                    if ("object" !== typeof m) this.options.text = m; else for (var e in m) this.modules[e] ? b.extend(!0, this.options[e], m[e]) : this.options[e] = m[e]
                }
            },
            ...
            position: function (c) {
                var a =
                    this.options.stack, b = this.elem;
        ...
        b.extend(d, {
            notices: [], reload: q, removeAll: function () {
                ...
                bootstrap3: {
                    ...
                    success_icon: "fa fa-check-circle-o",
                    error: "alert-danger",
